 ...
 */
final class Version20260413081040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chevalier_requests ADD emergency_contact_name VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE chevalier_requests ADD selfie_path VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE chevalier_requests ADD selfie_with_cip_path VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE chevalier_requests ADD vehicle_card_number VARCHAR(100) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE "user" ADD residence_address VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE "user" ADD vehicle_type VARCHAR(50) DEFAULT NULL');
        $this->addSql('ALTER TABLE "user" ADD vehicle_registration VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE "user" ADD vehicle_card_number VARCHAR(100) DEFAULT NULL');
